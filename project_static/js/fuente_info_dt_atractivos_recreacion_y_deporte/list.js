            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        html += '<i class="fas fa-edit" onclick="location.href=\'dt-atractivos-recreacion-deporte/edit/' + row.id + '/\'"></i>';
                        html += '<form method="post" action="dt-atractivos-recreacion-deporte/delete/' + row.id + '/">';
