            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        html += '<i class="fas fa-edit" onclick="location.href=\'dt-recintos-auditorios-salones/edit/' + row.id + '/\'"></i>';
                        html += '<form method="post" action="dt-recintos-auditorios-salones/delete/' + row.id + '/">';
