    ...
    list: function () {
        ...
        $('#dataTable').DataTable({
            ...
            columns: [
                ...
                {"data": "nombre", className: "text-left tb-text "},
                {"data": "fecha", className: "text-left tb-text "},
                {"data": "origen_visitante", className: "text-left tb-text "},
                {"data": "visitantes", className: "text-left tb-text "},
            ...
            ],columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        html += '<i class="fas fa-edit" onclick="location.href=\'zonas_arqueologicas/edit/' + row.id + '/\'"></i>';
                        html += '<form method="post" action="zonas_arqueologicas/delete/' + row.id + '/">';
