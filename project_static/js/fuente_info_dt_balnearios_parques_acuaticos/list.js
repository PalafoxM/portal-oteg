            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        html += '<i class="fas fa-edit" onclick="location.href=\'dt-balnearios-parques-acuaticos/edit/' + row.id + '/\'"></i>';
                        html += '<form method="post" action="dt-balnearios-parques-acuaticos/delete/' + row.id + '/">';
