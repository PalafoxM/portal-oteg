...
var aeropuerto = {
    list: function () {
        console.log("Ejecutando aeropuerto.list()", window.location.pathname); // Mensaje de depuració
        $('#dataTable').DataTable({
            responsive: true,
            autoWidth: false,
            destroy: true,
            ...
            columns: [
                ...
                {"data": "vuelos", className: "text-left tb-text "},
                {"data": "pasajeros_aeropuerto_gto", className: "text-left tb-text "},
                {"data": "pasajeros_nacionales", className: "text-left tb-text "},
                {"data": "pasajeros_internacionales", className: "text-left tb-text "},
