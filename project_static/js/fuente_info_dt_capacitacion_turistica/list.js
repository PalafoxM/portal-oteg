            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        html += '<i class="fas fa-edit" onclick="location.href=\'dt-capacitacion-turistica/edit/' + row.id + '/\'"></i>';
                        html += '<form method="post" action="dt-capacitacion-turistica/delete/' + row.id + '/">';
