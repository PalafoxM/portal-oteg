    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            try:
                ...
                # Creamos la instancia del mensaje
                subject, from_email = 'Solicitud de Informacion', settings.EMAIL_HOST_USER
                to_list = [settings.CORREO_DESTINO1, settings.CORREO_DESTINO1, settings.CORREO_DESTINO2, settings.CORREO_DESTINO3] # Agrega aquí las direcciones de correo de los destinatarios
                msg = EmailMultiAlternatives(subject, text_content, from_email, to_list)
