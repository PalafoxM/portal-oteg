...
class FuenteInfoDirectorioSpa(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioSpa.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Spa'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_spa_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioSpa'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_spa_carga_masiva')
...
class FuenteInfoDirectorioSpaCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioSpa.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioSpa.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
                ...
                table_html = render_to_string('back/fuente_info_dt_spa/table.html', {
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_spa')
        context['action'] = 'add'
        return context
...
class DirectorioSpaCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Spa'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Spa',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_spa'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioSpa.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioSpaDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioSpa
        fields = DirectorioSpa._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioSpa
