...
class FuenteInfoDirectorioAuxilioTuristico(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioAuxilioTuristico.objects.all():
                    print("turistico")
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Auxilio Turistico'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_auxilio_turistico_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioAuxilioTuristico'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_auxilio_turistico_carga_masiva')
...
class FuenteInfoDirectorioAuxilioTuristicoCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioAuxilioTuristico.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioAuxilioTuristico.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_auxilio_turistico')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioAuxilioTuristicoUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_auxilio_turistico')
...
class DirectorioAuxilioTuristicoCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Auxilio Turistico'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Auxilio Turistico',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_auxilio_turistico'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioAuxilioTuristico.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioAuxilioTuristicoDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioAuxilioTuristico
        fields = DirectorioAuxilioTuristico._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioAuxilioTuristico
