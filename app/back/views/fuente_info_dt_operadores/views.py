...
class FuenteInfoDirectorioOperadores(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioOperadores.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Operadores'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_operadores_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioOperadores'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_operadores_carga_masiva')
...
class FuenteInfoDirectorioOperadoresCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioOperadores.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioOperadores.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_operadores')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioOperadoresUpdate (UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_operadores')
...
class DirectorioOperadoresCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Operadores'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Operadores',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_operadores'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioOperadores.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioOperadoresDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioOperadores
        fields = DirectorioOperadores._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioOperadores
