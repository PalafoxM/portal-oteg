...
class FuenteInfoDirectorioAlimentosYBebidasCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if existing_object:
                data = DirectorioAlimentosYBebidas.objects.filter(
                    nombre_de_la_unidad_economica=nombre_de_la_unidad_economica, id_establecimiento=id_establecimiento)
                ...
                table_html = render_to_string('back/fuente_info_dt_alimentos_y_bebidas/table.html', {
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente Directorio Alimentos Y Bebidas'
        context['entity'] = 'Directorio Alimentos Y Bebidas'
...
class DirectorioAlimentosYBebidasDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioAlimentosYBebidas
        campos = [field.name for field in DirectorioAlimentosYBebidas._meta.get_fields()
                  if field.name != 'id']
