...
class FuenteInfoDirectorioAlimentosYBebidas(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioAlimentosYBebidas.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Alimentos Y Bebidas'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_alimentos_y_bebidas_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioAlimentosYBebidas'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_alimentos_y_bebidas_carga_masiva')
...
class FuenteInfoDirectorioAlimentosYBebidasCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                existing_object = DirectorioAlimentosYBebidas.objects.filter(destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro).first()


            except DirectorioAlimentosYBebidas.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioAlimentosYBebidas.objects.filter(destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro).first()  
                ...
                table_html = render_to_string('back/fuente_info_dt_agencias_de_viajes/table.html', {
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_alimentos_y_bebidas')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioAlimentosYBebidasUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_alimentos_y_bebidas')
        ...
        context['edit_msg'] = 'Los campos entidad, giro , destino , clave_del_giro no puden ser editados'
...
class DirectorioAlimentosYBebidasCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de DirectorioAlimentosYBebidas'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de DirectorioAlimentosYBebidas',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_alimentos_y_bebidas'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioAlimentosYBebidas.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
                    ...
                    if existente.exists():
                        ...
                        db = DirectorioAlimentosYBebidas(
                            giro=giro,
                            clave_del_giro=clave_del_giro,
                            entidad=entidad,
                            clave_entidad=clave_entidad,
...
class DirectorioAlimentosYBebidasDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioAlimentosYBebidas
        fields = DirectorioAlimentosYBebidas._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioAlimentosYBebidas
