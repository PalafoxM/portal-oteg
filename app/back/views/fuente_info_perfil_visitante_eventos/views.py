...
class FuenteInfoPerfilVisitanteEventos(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('dashboard:fuente_info_perfil_visitante_eventos_create')
...
class FuenteInfoPerfilVisitanteEventosCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            try:
                existing_object = self.get_object(fecha=fecha, destino=destino, nombre_evento=evento)
            ...
            if existing_object:
                data = FuenteInfoPerfilVisitanteEvento.objects.filter(fecha=fecha, destino=destino, nombre_evento=evento)
    ...
    'codigo_encuesta_ano'
                ...
                table_html = render_to_string('back/fuente_info_perfil_visitante_eventos/table.html',{'data_list': data_list, 'actual': True, 'data_list2': data_list2})
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_perfil_visitante_eventos')
        context['action'] = 'add'
        return context
...
class FuenteInfoPerfilVisitanteEventosUpdate(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['form'].fields['nombre_evento'].widget = forms.TextInput(attrs={'readonly': 'readonly'})
