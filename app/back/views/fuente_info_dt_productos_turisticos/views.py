...
class FuenteInfoDirectorioProductosTuristicos(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioProductosTuristicos.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Productos Turisticos'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_productos_turisticos_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioProductosTuristicos'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_productos_turisticos_carga_masiva')
...
class FuenteInfoDirectorioProductosTuristicosCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioProductosTuristicos.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioProductosTuristicos.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)
                ...
                table_html = render_to_string('back/fuente_info_dt_productos_turisticos/table.html', {
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_productos_turisticos')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioProductosTuristicosUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_productos_turisticos')
...
class DirectorioProductosTuristicosCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Productos Turisticos'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Productos Turisticos',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_productos_turisticos'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioProductosTuristicos.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
                    ...
                    if existente.exists():
                        ...
                        db = DirectorioProductosTuristicos(
                            giro=giro,
                            clave_del_giro=clave_del_giro,
                            entidad=entidad,
                            clave_entidad=clave_entidad,
...
class DirectorioProductosTuristicosDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioProductosTuristicos
        fields = DirectorioProductosTuristicos._meta.get_fields()
        column_labels = [
        ...
        # Obtener los datos del modelo DirectorioProductosTuristicos
