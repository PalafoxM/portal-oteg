...
class FuenteInfoDirectorioProductosTuristicosCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if existing_object:
                data = DirectorioProductosTuristicos.objects.filter(
                    nombre_de_la_unidad_economica=nombre_de_la_unidad_economica, id_establecimiento=id_establecimiento)
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente Directorio Productos Turisticos'
        context['entity'] = 'Directorio Productos Turisticos'
...
class DirectorioProductosTuristicosDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioProductosTuristicos
        campos = [field.name for field in DirectorioProductosTuristicos._meta.get_fields()
                  if field.name != 'id']
