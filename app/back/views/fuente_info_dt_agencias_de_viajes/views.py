...
class FuenteInfoDirectorioAgenciasDeViajes(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioAgenciasDeViajes.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Agencias De Viajes'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_agencias_de_viajes_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioAgenciasDeViajes'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_agencias_de_viajes_carga_masiva')
...
class FuenteInfoDirectorioAgenciasDeViajesCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if existing_object:
                data = DirectorioAgenciasDeViajes.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_agencias_de_viajes')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioAgenciasDeViajesUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_agencias_de_viajes')
...
class DirectorioAgenciasDeViajesCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_agencias_de_viajes'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioAgenciasDeViajes.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioAgenciasDeViajesDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioAgenciasDeViajes
        fields = DirectorioAgenciasDeViajes._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioAgenciasDeViajes
