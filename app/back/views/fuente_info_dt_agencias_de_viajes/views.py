...
class FuenteInfoDirectorioAgenciasDeViajesCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if existing_object:
                data = DirectorioAgenciasDeViajes.objects.filter(
                    nombre_de_la_unidad_economica=nombre_de_la_unidad_economica, id_establecimiento=id_establecimiento)
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente Directorio Agencias De Viajes'
        context['entity'] = 'Directorio Agencias De Viajes'
...
class DirectorioAgenciasDeViajesDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioAgenciasDeViajes
        campos = [field.name for field in DirectorioAgenciasDeViajes._meta.get_fields()
                  if field.name != 'id']
