...
class FuenteInfoDirectorioCapacitacionTuristica(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioCapacitacionTuristica.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Capacitacion Turistica'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_capacitacion_turistica_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioCapacitacionTuristica'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_capacitacion_turistica_carga_masiva')

        return context


class FuenteInfoDirectorioCapacitacionTuristicaCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    model = DirectorioCapacitacionTuristica
    form_class = DirectorioCapacitacionTuristicaForm
    template_name = 'back/fuente_info_dt_capacitacion_turistica/create.html'
...
class FuenteInfoDirectorioCapacitacionTuristicaUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    model = DirectorioCapacitacionTuristica
    form_class = DirectorioCapacitacionTuristicaForm
...
class FuenteInfoDirectorioCapacitacionTuristicaDelete (SuperAdminOrAdminMixin, LoginRequiredMixin, DeleteView):
    model = DirectorioCapacitacionTuristica
    success_url = reverse_lazy(
        'dashboard:fuente_info_dt_capacitacion_turistica')
...
class DirectorioCapacitacionTuristicaCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Capacitacion Turistica'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Capacitacion Turistica',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_capacitacion_turistica'))
    ...
    def procesar_archivo_xlsx(self, archivo):
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                ret = row[19].value
                tipo = row[20].value
                lic_gastronomia = row[21].value
                lic_turismo = row[22].value
                posgrado_en_turismo = row[23].value
                certificacion_como_guia_de_turista = row[24].value
                otros_estudios_en_turismo = row[25].value
                rnt = row[26].value
                ...
                try:
                    ...
                    existente = DirectorioCapacitacionTuristica.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
                    ...
                    if existente.exists():
                        ...
                        db = DirectorioCapacitacionTuristica(
                            giro=giro,
                            clave_del_giro=clave_del_giro,
                            entidad=entidad,
                            clave_entidad=clave_entidad,
    ...
    def procesar_archivo_csv(self, archivo):
        ...
        try:
            ...
            for row in datos:
                ...
                ret = row['ret']
                tipo = row['tipo']
                lic_gastronomia = row['lic_gastronomia']
                lic_turismo = row['lic_turismo']
                posgrado_en_turismo = row['posgrado_en_turismo']
                certificacion_como_guia_de_turista = row['certificacion_como_guia_de_turista']
                otros_estudios_en_turismo = row['otros_estudios_en_turismo']
                rnt = row['rnt']
...
class DirectorioCapacitacionTuristicaDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los datos del modelo DirectorioCapacitacionTuristica
