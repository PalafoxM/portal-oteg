...
class DirectorioCapacitacionTuristicaDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioCapacitacionTuristica
        campos = [field.name for field in DirectorioCapacitacionTuristica._meta.get_fields()
                  if field.name != 'id']
