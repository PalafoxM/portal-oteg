...
class FuenteInfoDirectorioBalneariosParquesAcuaticos(SuperAdminOrAdminMixin, LoginRequiredMixin, ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioBalneariosParquesAcuaticos.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Balnearios Parques Acuaticos'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_balnearios_parques_acuaticos_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioBalneariosParquesAcuaticos'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_balnearios_parques_acuaticos_carga_masiva')
...
class FuenteInfoDirectorioBalneariosParquesAcuaticosCreate (SuperAdminOrAdminMixin, LoginRequiredMixin, CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioBalneariosParquesAcuaticos.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioBalneariosParquesAcuaticos.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
                data_list = list(data.values('giro',
                                             ...
                                             'ret',
                                             'rnt',
                                             'numero_albercas','numero_toboganes','aguas_termales'))
                

                data_list2 = list(form.cleaned_data.values())
                table_html = render_to_string('back/fuente_info_dt_balnearios_parques_acuaticos/table.html', {
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente de información de DirectorioBalneariosParquesAcuaticos'
        context['entity'] = 'Fuentes de Informacion de DirectorioBalneariosParquesAcuaticos'
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_balnearios_parques_acuaticos')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioBalneariosParquesAcuaticosUpdate (SuperAdminOrAdminMixin, LoginRequiredMixin, UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_balnearios_parques_acuaticos')
...
class DirectorioBalneariosParquesAcuaticosCargaMasivaView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Balnearios Parques Acuaticos'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Balnearios Parques Acuaticos',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_balnearios_parques_acuaticos'))
    ...
    def procesar_archivo_xlsx(self, archivo):
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                ret = row[19].value
                rnt = row[20].value
                numero_albercas = row[21].value
                numero_toboganes = row[22].value
                aguas_termales = row[23].value
                ...
                datos = {
                    ...
                    'ret': ret,
                    'rnt': rnt,
                    'numero_albercas': numero_albercas,
                    'numero_toboganes': numero_toboganes,
                    'aguas_termales': aguas_termales,
                }
                ...
                try:
                    ...
                    existente = DirectorioBalneariosParquesAcuaticos.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
                    ...
                    if existente.exists():
                        ...
                        db = DirectorioBalneariosParquesAcuaticos(
                            giro=giro,
                            clave_del_giro=clave_del_giro,
                            entidad=entidad,
                            clave_entidad=clave_entidad,
    ...
    def procesar_archivo_csv(self, archivo):
        ...
        try:
            ...
            for row in datos:
                ...
                ret = row['ret']
                rnt = row['rnt']
                numero_albercas = row['numero_albercas']
                numero_toboganes = row['numero_toboganes']
                aguas_termales = row['aguas_termales']
...
class DirectorioBalneariosParquesAcuaticosDescargarArchivoView(SuperAdminOrAdminMixin, LoginRequiredMixin, View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioBalneariosParquesAcuaticos
        fields = DirectorioBalneariosParquesAcuaticos._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioBalneariosParquesAcuaticos
