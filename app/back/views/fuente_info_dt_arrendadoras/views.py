...
class FuenteInfoDirectorioArrendadorasCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            if existing_object:
                data = DirectorioArrendadoras.objects.filter(
                    nombre_de_la_unidad_economica=nombre_de_la_unidad_economica, id_establecimiento=id_establecimiento)
                ...
                table_html = render_to_string('back/fuente_info_dt_arrendadoras/table.html', {
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente Directorio arrendadoras'
        context['entity'] = 'Directorio arrendadoras'
...
class DirectorioArrendadorasDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioArrendadoras
        campos = [field.name for field in DirectorioArrendadoras._meta.get_fields()
                  if field.name != 'id']
