...
class FuenteInfoDirectorioArrendadoras(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioArrendadoras.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio arrendadoras'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_arrendadoras_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioArrendadoras'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_arrendadoras_carga_masiva')
...
class FuenteInfoDirectorioArrendadorasCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioArrendadoras.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioArrendadoras.objects.filter( destino=destino, entidad=entidad, giro=giro, clave_del_giro=clave_del_giro)   
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('dashboard:fuente_info_dt_arrendadoras')
        context['action'] = 'add'
        return context
...
class FuenteInfoDirectorioArrendadorasUpdate (UpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_arrendadoras')
...
class DirectorioArrendadorasCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio arrendadoras'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio arrendadoras',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_arrendadoras'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioArrendadoras.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioArrendadorasDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres y verbose_name de los campos del modelo DirectorioArrendadoras
        fields = DirectorioArrendadoras._meta.get_fields()
        ...
        # Obtener los datos del modelo DirectorioArrendadoras
