...
class FuenteInfoDirectorioCampoDeGolf(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioCampoDeGolf.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Campo De Golf'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_campo_de_golf_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioCampoDeGolf'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_campo_de_golf_carga_masiva')
...
class DirectorioCampoDeGolfCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Campo De Golf'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Campo De Golf',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_campo_de_golf'))
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                try:
                    ...
                    existente = DirectorioCampoDeGolf.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
...
class DirectorioCampoDeGolfDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioCampoDeGolf
        campos = [field.name for field in DirectorioCampoDeGolf._meta.get_fields()
                  if field.name != 'id']
        ...
        # Obtener los datos del modelo DirectorioCampoDeGolf
