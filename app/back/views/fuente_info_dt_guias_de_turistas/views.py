...
class FuenteInfoDirectorioGuiasDeTuristas(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioGuiasDeTuristas.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Guias De Turistas'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_guias_de_turistas_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioGuiasDeTuristas'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_guias_de_turistas_carga_masiva')
...
class FuenteInfoDirectorioGuiasDeTuristasCreate (CreateView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            except DirectorioGuiasDeTuristas.DoesNotExist:
            ...
            if existing_object:
                data = DirectorioGuiasDeTuristas.objects.filter(
                    nombre_de_la_unidad_economica=nombre_de_la_unidad_economica, id_establecimiento=id_establecimiento)
                ...
                table_html = render_to_string('back/fuente_info_dt_guias_de_turistas/table.html', {
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Crear una fuente Directorio Guias De Turistas'
        context['entity'] = 'Directorio Guias De Turistas'
        context['list_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_guias_de_turistas')
        context['action'] = 'add'
        return context
...
class DirectorioGuiasDeTuristasCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Guias De Turistas'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Guias De Turistas',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_guias_de_turistas'))
    ...
    def procesar_archivo_xlsx(self, archivo):
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                rnt = row[19].value
                tipo = row[20].value
                no_acreditacion = row[21].value
                vigencia_acreditacion = row[22].value
                especialidad = row[23].value
                ...
                datos = {
                    ...
                    'vigencia_acreditacion': vigencia_acreditacion,
                ...
                try:
                    ...
                    existente = DirectorioGuiasDeTuristas.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
    ...
    def procesar_archivo_csv(self, archivo):
        ...
        try:
            ...
            for row in datos:
                ...
                vigencia_acreditacion = row['vigencia_acreditacion']
...
class DirectorioGuiasDeTuristasDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los datos del modelo DirectorioGuiasDeTuristas
