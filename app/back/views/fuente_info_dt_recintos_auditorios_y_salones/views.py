...
class FuenteInfoDirectorioRecintosAuditoriosYSalones(ListView):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            ...
            if action == 'search':
                data = []
                for i in DirectorioRecintosAuditoriosYSalones.objects.all():
    ...
    def get_context_data(self, **kwargs):
        ...
        context['title'] = 'Listado  de Directorio Recintos Auditorios Y Salones'
        context['create_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_recintos_auditorios_y_salones_create')
        context['entity'] = 'Fuentes de Informacion de DirectorioRecintosAuditoriosYSalones'
        context['is_fuente'] = True
        context['carga_masiva_url'] = reverse_lazy(
            'dashboard:fuente_info_dt_recintos_auditorios_y_salones_carga_masiva')
...
class DirectorioRecintosAuditoriosYSalonesCargaMasivaView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, self.template_name, {'form': form, 'title': 'Carga Masiva de Directorio Recintos Auditorios Y Salones'})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if len(registros_incorrectos) > 0 or len(registros_existentes) > 0:
            ...
            return render(request, self.template_name, {
                'form': form,
                'title': 'Carga Masiva de Directorio Recintos Auditorios Y Salones',
            ...
            return HttpResponseRedirect(reverse('dashboard:fuente_info_dt_recintos_auditorios_y_salones'))
    ...
    def procesar_archivo_xlsx(self, archivo):
        ...
        try:
            ...
            for i, row in enumerate(filas):
                ...
                ret = row[19].value
                rnt = row[20].value
                modalidad = row[21].value
                depende_de_hotel_o_restaurante = row[22].value
                no_de_salones = row[23].value
                capacidad_maxima = row[24].value
                ...
                try:
                    ...
                    existente = DirectorioRecintosAuditoriosYSalones.objects.filter(
                        giro=giro,
                        clave_del_giro=clave_del_giro,
                        entidad=entidad,
                        destino=destino,
                    ...
                    if existente.exists():
                        ...
                        db = DirectorioRecintosAuditoriosYSalones(
                            giro=giro,
                            clave_del_giro=clave_del_giro,
                            entidad=entidad,
                            clave_entidad=clave_entidad,
    ...
    def procesar_archivo_csv(self, archivo):
        ...
        try:
            ...
            for row in datos:
                ...
                depende_de_hotel_o_restaurante = row['depende_de_hotel_o_restaurante']
                no_de_salones = row['no_de_salones']
...
class DirectorioRecintosAuditoriosYSalonesDescargarArchivoView(View):
    ...
    def crear_archivo_excel(self, registros_incorrectos):
        ...
        # Obtener los nombres de los campos del modelo DirectorioRecintosAuditoriosYSalones
        campos = [field.name for field in DirectorioRecintosAuditoriosYSalones._meta.get_fields()
                  if field.name != 'id']
        ...
        # Obtener los datos del modelo DirectorioRecintosAuditoriosYSalones
