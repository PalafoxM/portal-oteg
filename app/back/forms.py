...
class DirectorioAgenciasDeViajesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'giro': forms.TextInput(attrs={'class': 'form-control'}),
            'clave_del_giro': forms.NumberInput(attrs={'class': 'form-control'}),
            'entidad': forms.TextInput(attrs={'class': 'form-control'}),
            'clave_entidad': forms.NumberInput(attrs={'class': 'form-control'}),
            'destino': forms.TextInput(attrs={'class': 'form-control'}),
            'clave_municipio': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'lada': forms.NumberInput(attrs={'class': 'form-control'}),
            ...
            'ret': forms.TextInput(attrs={'class': 'form-control'}),
            'rnt': forms.TextInput(attrs={'class': 'form-control'})
        }
...
class DirectorioBalneariosParquesAcuaticosForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'sitio_web': forms.TextInput(attrs={'class': 'form-control'}),
            'ret': forms.TextInput(attrs={'class': 'form-control'}),
            'numero_albercas': forms.TextInput(attrs={'class': 'form-control'}),
            'numero_toboganes': forms.TextInput(attrs={'class': 'form-control'}),
            'aguas_termales': forms.TextInput(attrs={'class': 'form-control'}),
        }
...
class DirectorioCapacitacionTuristicaForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'ret': forms.TextInput(attrs={'class': 'form-control'}),
            'tipo': forms.TextInput(attrs={'class': 'form-control'}),
            'lic_gastronomia': forms.TextInput(attrs={'class': 'form-control'}),
            'lic_turismo': forms.TextInput(attrs={'class': 'form-control'}),
            'posgrado_en_turismo': forms.TextInput(attrs={'class': 'form-control'}),
            'certificacion_como_guia_de_turista': forms.TextInput(attrs={'class': 'form-control'}),
            'otros_estudios_en_turismo': forms.TextInput(attrs={'class': 'form-control'}),
            'rnt': forms.TextInput(attrs={'class': 'form-control'})
        }
...
class DirectorioGuiasDeTuristasForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'rnt': forms.TextInput(attrs={'class': 'form-control'}),
            'tipo': forms.TextInput(attrs={'class': 'form-control'}),
            'no_acreditacion': forms.TextInput(attrs={'class': 'form-control'}),
            'vigencia_acreditacion': forms.TextInput(attrs={'class': 'form-control'}),
...
class DirectorioRecintosAuditoriosYSalonesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'depende_de_hotel_o_restaurante': forms.TextInput(attrs={'class': 'form-control'}),
            'no_de_salones': forms.TextInput(attrs={'class': 'form-control'}),
            'capacidad_maxima': forms.TextInput(attrs={'class': 'form-control'}),
        }
