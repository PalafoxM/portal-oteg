...
from contenido.models import  Banner, PlacesOfInterest
from contenido.forms import BannerForm, PlacesOfInterestForm
...
def places_list(request):
    data = {
        ...
        'create_url': reverse_lazy('colaboradores:place_create'),
...
class  PlaceCreateView(CreateView):
    ...
    template_name = 'back/publicaciones/create.html'
    success_url = reverse_lazy('colaboradores:place_list')
    ...
    def get_context_data(self, **kwargs):
        ...
        context['list_url'] = reverse_lazy('colaboradores:place_list')
        context['action'] = 'add'
        return context
