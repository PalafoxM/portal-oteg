...
destinos={'abasolo' : 'abasolo',
    ...
    'acambaro' : 'acambaro',
    'acámbaro' : 'acambaro',
    'acámbaro y san miguel de allende':'acambaro',
    ...
    'dolores hidalgo cuna de la iepeencia nacional':'dolores hidalgo cin',
    ...
    'jalpa de canovas':'jalpa de canovas',
    'jalpa de cánovas':'jalpa de canovas',
    'jalpa' : 'jalpa de canovas',
    'tarandacuao, jerécuaro y coroneo':'jerecuaro',
    'jerecuaro' : 'jerecuaro',
    'jerécuaro' : 'jerecuaro',
    'juventino rosas' : 'santa cruz de juventino rosas',
    'leon' : 'león',
    'león' : 'león',
    'león y jalpa de cánovas':'león',
    'manuel doblado' : 'manuel doblado',
    'cd. manuel doblado':'manuel doblado',
    'mineral de pozos / san luis de la paz' : 'mineral de pozos',
    'mineral de pozos' : 'mineral de pozos',
    'mineral de posos' : 'mineral de pozos',
    'mineral pozos': 'mineral de pozos',
    'san luis de la paz (mineral de pozos)': 'mineral de pozos',
    'moroleón' : 'moroleón',
    'ocampo' : 'ocampo',
    'penjamo' : 'penjamo',
    'pénjamo' : 'penjamo',
    ...
    'púrisima del rincón' : 'purisima del rincon',
    'púrisima del rincon' : 'purisima del rincon',
    'purísima del rincón (jalpa de cánovas)':'purisima del rincon',
    'san francisco del rincón y purísima del rincón':'purisima del rincon',
    ...
    'san fco. del rincon': 'san francisco del rincón',
    'sn fco.del rincon': 'san francisco del rincón',
    'san fco.del rincon': 'san francisco del rincón',
    'san josé iturbide' : 'san josé iturbide',
    'san jose iturbide' : 'san josé iturbide',
    'sn josé iturbide' : 'san josé iturbide',
    'sn jose iturbide' : 'san josé iturbide',
    ...
    'san miguel de allende y dolores hidalgo':'san miguel de allende',
...
def parse_fecha(fecha_str):
    if isinstance(fecha_str, datetime):
        return fecha_str.date()  # Si ya es un objeto datetime, retorna solo la fecha
